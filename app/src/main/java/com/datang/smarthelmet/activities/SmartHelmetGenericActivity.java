...
/*
SmartHelmetGenericActivity.java
...
public abstract class SmartHelmetGenericActivity extends ThemeableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!SmartHelmetService.isReady()) {
            startActivity(getIntent().setClass(this, SmartHelmetLauncherActivity.class));
            mAbortCreation = true;
            finish();
        }
    }
