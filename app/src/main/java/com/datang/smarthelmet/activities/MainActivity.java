...
import static com.datang.smarthelmet.utils.LocationUtils.currentPosition;
...
import com.datang.smarthelmet.contacts.ContactsActivity;
import com.datang.smarthelmet.contacts.ContactsManager;
import com.datang.smarthelmet.contacts.SmartHelmetContact;
import com.datang.smarthelmet.fragments.EmptyFragment;
import com.datang.smarthelmet.fragments.StatusBarFragment;
import com.datang.smarthelmet.history.HistoryActivity;
import com.datang.smarthelmet.menu.SideMenuFragment;
import com.datang.smarthelmet.settings.LinphonePreferences;
import com.datang.smarthelmet.settings.SettingsActivity;
import com.datang.smarthelmet.utils.DeviceUtils;
import com.datang.smarthelmet.utils.LocationUtils;
import com.datang.smarthelmet.utils.NetWorkUtils;
import com.datang.smarthelmet.utils.PushNotificationUtils;
...
public abstract class MainActivity extends SmartHelmetGenericActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (NetWorkUtils.isNetworkAvailable(MainActivity.this)) {
            ...
            // 判断是否已获位置授权
            if (Compatibility.getLocations(MainActivity.this)) {
                // 如果已获授权则获取位置信息
        ...
        //    SmartHelmetService.speakText = currentPosition;
        // SmartHelmetService.playTTS(currentPosition);
        ...
        test.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    @Override
                    public void onClick(View v) {
                        //       Toast.makeText(MainActivity.this, "这是一条test消息",
                        // Toast.LENGTH_LONG).show();

                        // Compatibility.changeFlashLight(MainActivity.this, true);
                    }
                });
        ...
        mTestSelected = findViewById(R.id.test_select);
                        ...
                        if (state == RegistrationState.Ok) {
                            ...
                            if (getResources().getBoolean(R.bool.use_phone_number_validation)) {
                                ...
                                if (authInfo != null
                                    ...
                                    SmartHelmetManager.getInstance().isAccountWithAlias();
                                }
                            }
    ...
    private void quit() {
        goHomeAndClearStack();
        stopService(new Intent(Intent.ACTION_MAIN).setClass(this, SmartHelmetService.class));
    ...
    public void onRequestPermissionsResult(
        ...
        for (int i = 0; i < permissions.length; i++) {
            ...
            if (permissions[i].equals(Manifest.permission.READ_CONTACTS)
                ...
                SmartHelmetManager.getInstance().enableDeviceRingtone(enableRingtone);
                // 拍照授权
    ...
    public void goBackToCall() {
        ...
        Call[] calls = SmartHelmetManager.getCore().getCalls();
    ...
    public void showContactDetails(SmartHelmetContact contact) {
    ...
    public Dialog displayDialog(String text) {
        return SmartHelmetUtils.getDialog(this, text);
    }
