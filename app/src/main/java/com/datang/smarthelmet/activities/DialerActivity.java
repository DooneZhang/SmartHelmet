...
import com.datang.smarthelmet.views.AddressText;
import com.datang.smarthelmet.views.CallButton;
import com.datang.smarthelmet.views.Digit;
import com.datang.smarthelmet.views.EraseButton;
...
public class DialerActivity extends MainActivity implements AddressText.AddressChangedListener {
    ...
    private void handleIntentParams(Intent intent) {
        ...
        if (ACTION_CALL_LINPHONE.equals(action)
            ...
            SmartHelmetManager.getCallManager().newOutgoingCall(numberToCall, null);
        } else {
