...
import com.datang.smarthelmet.notifications.NotifiableMessage;
import com.datang.smarthelmet.notifications.NotificationBroadcastReceiver;
...
class ApiTwentyFourPlus {
    ...
    public static Notification createMessageNotification(
        ...
        return new Notification.Builder(context)
                ...
                .setGroup(Compatibility.CHAT_NOTIFICATIONS_GROUP)
