...
public class ContactsActivity extends MainActivity {
    ...
    private void handleIntentExtras(Bundle extras) {
        ...
        if (extras.containsKey("ContactUri")) {
            ...
            SmartHelmetContact linphoneContact =
            ...
            SmartHelmetContact contact = (SmartHelmetContact) extras.get("Contact");
    ...
    public void showContactEdit(SmartHelmetContact contact) {
    ...
    private void showContactDetails(SmartHelmetContact contact, boolean isChild) {
        if (mEditOnClick) {
    ...
    private void showContactEdit(SmartHelmetContact contact, boolean isChild) {
        showContactEdit(contact, new Bundle(), isChild);
    }

    private void showContactEdit(SmartHelmetContact contact, Bundle extras, boolean isChild) {
        if (contact != null) {
            extras.putSerializable("Contact", contact);
        }
        if (mEditOnClick) {
