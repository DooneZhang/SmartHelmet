...
public class ContactEditorFragment extends Fragment {
    ...
    private SmartHelmetContact mContact;
    private List<SmartHelmetNumberOrAddress> mNumbersAndAddresses;
    ...
    public View onCreateView(
        ...
        if (getArguments() != null) {
            mContact = (SmartHelmetContact) getArguments().getSerializable("Contact");
            ...
            mContact = (SmartHelmetContact) savedInstanceState.get("Contact");
                ...
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mIsNewContact) {
                            ...
                            for (SmartHelmetNumberOrAddress nounoa : mNumbersAndAddresses) {
                            ...
                            mContact = SmartHelmetContact.createContact();
                        }
                        ...
                        for (SmartHelmetNumberOrAddress noa : mNumbersAndAddresses) {
                            if (noa.getValue() == null || noa.getValue().isEmpty()) {
                                ...
                                if (noa.isSIPAddress()) {
                                    ...
                                    noa.setValue(
                                            SmartHelmetUtils.getFullAddressFromUsername(
                                                    noa.getValue()));
                                }
    ...
    private LinearLayout initNumbersFields(final SmartHelmetContact contact) {
        LinearLayout controls = mView.findViewById(R.id.controls_numbers);
        controls.removeAllViews();

        if (contact != null) {
            for (SmartHelmetNumberOrAddress numberOrAddress : contact.getNumbersOrAddresses()) {
        ...
        if (mNewSipOrNumberToAdd != null) {
            boolean isSip =
                    SmartHelmetUtils.isStrictSipAddress(mNewSipOrNumberToAdd)
                            || !SmartHelmetUtils.isNumberAddress(mNewSipOrNumberToAdd);
            if (!isSip) {
    ...
    private LinearLayout initSipAddressFields(final SmartHelmetContact contact) {
    ...
    private View displayNumberOrAddress(
        ...
        if (isSIP) {
            ...
            if (getResources()
                ...
                displayedNumberOrAddress =
                        SmartHelmetUtils.getDisplayableUsernameFromAddress(numberOrAddress);
            }
        }
        ...
        SmartHelmetNumberOrAddress tempNounoa;
        if (mIsNewContact || mNewSipOrNumberToAdd != null) {
            tempNounoa = new SmartHelmetNumberOrAddress(numberOrAddress, isSIP);
        } else {
            tempNounoa = new SmartHelmetNumberOrAddress(numberOrAddress, isSIP, numberOrAddress);
        }
        final SmartHelmetNumberOrAddress nounoa = tempNounoa;
    ...
    private void addEmptyRowToAllowNewNumberOrAddress(
        ...
        final View view = mInflater.inflate(R.layout.contact_edit_cell, null);
        final SmartHelmetNumberOrAddress nounoa = new SmartHelmetNumberOrAddress(null, isSip);
