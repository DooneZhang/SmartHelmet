...
public class ContactAddress implements Serializable {
    ...
    public ContactAddress(SmartHelmetContact c, String a, String pn) {
        init(c, a, pn);
    }

    public ContactAddress(SmartHelmetContact c, String a, String pn, boolean isAdmin) {
        init(c, a, pn);
        mIsAdmin = isAdmin;
    }
    ...
    public SmartHelmetContact getContact() {
        return mContact;
    }
    ...
    private void init(SmartHelmetContact c, String a, String pn) {
        mContact = c;
        mAddress = a;
        mPhoneNumber = pn;
    }
