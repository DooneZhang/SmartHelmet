...
/*
SmartHelmetNumberOrAddress.java
...
public class SmartHelmetNumberOrAddress
        implements Serializable, Comparable<SmartHelmetNumberOrAddress> {
    ...
    public SmartHelmetNumberOrAddress(String v, boolean isSIP) {
        mValue = v;
        mIsSIPAddress = isSIP;
    ...
    public SmartHelmetNumberOrAddress(String v, String normalizedV) {
        mValue = v;
    ...
    public SmartHelmetNumberOrAddress(String v, boolean isSip, String old) {
        this(v, isSip);
        mOldValueForUpdatePurpose = old;
    }

    @Override
    public int compareTo(SmartHelmetNumberOrAddress noa) {
        if (mValue != null) {
    ...
    public boolean equals(Object obj) {
        if (obj.getClass() != SmartHelmetNumberOrAddress.class) return false;
        SmartHelmetNumberOrAddress noa = (SmartHelmetNumberOrAddress) obj;
