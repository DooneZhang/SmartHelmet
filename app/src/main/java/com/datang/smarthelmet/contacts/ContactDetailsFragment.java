...
public class ContactDetailsFragment extends Fragment implements ContactsUpdatedListener {
    ...
    private void changeDisplayedContact(SmartHelmetContact newContact) {
        mContact = newContact;
        displayContact(mInflater, mView);
    }
    ...
    private void displayContact(LayoutInflater inflater, View view) {
        ...
        for (SmartHelmetNumberOrAddress noa : mContact.getNumbersOrAddresses()) {
            boolean skip;
            ...
            if (getResources()
                ...
                displayedNumberOrAddress =
                        SmartHelmetUtils.getDisplayableUsernameFromAddress(value);
            }
            ...
            if (lpc != null) {
                ...
                if (username != null) {
                    value = SmartHelmetUtils.getFullAddressFromUsername(username);
                }
            }
