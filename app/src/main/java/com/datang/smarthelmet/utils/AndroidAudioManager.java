...
import com.datang.smarthelmet.receivers.BluetoothReceiver;
import com.datang.smarthelmet.receivers.HeadsetReceiver;
...
public class AndroidAudioManager {
    ...
    public synchronized void bluetoothHeadetScoConnectionChanged(boolean connected) {
        mIsBluetoothHeadsetScoConnected = connected;
        SmartHelmetManager.getCallManager().refreshInCallActions();
    }
