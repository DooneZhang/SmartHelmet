...
class Recording implements PlayerListener, Comparable<Recording> {
                    ...
                    public void run() {
                        ...
                        if (isPlaying())
                            SmartHelmetUtils.dispatchOnUIThreadAfter(
                                    mUpdateCurrentPositionTimer, 20);
                    }
                };

        mPlayer = SmartHelmetManager.getCore().createLocalPlayer(null, null, null);
    ...
    public void play() {
        ...
        mPlayer.start();
        SmartHelmetUtils.dispatchOnUIThread(mUpdateCurrentPositionTimer);
    }
