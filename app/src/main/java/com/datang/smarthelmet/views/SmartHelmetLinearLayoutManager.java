...
/*
SmartHelmetLinearLayoutManager.java
...
public class SmartHelmetLinearLayoutManager extends LinearLayoutManager {
    /**
    ...
    public SmartHelmetLinearLayoutManager(Context context) {
        super(context);
    }

    public SmartHelmetLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
    }

    public SmartHelmetLinearLayoutManager(
