...
public class SmartHelmetTextureViewOverlay extends RelativeLayout implements SmartHelmetOverlay {
    ...
    public SmartHelmetTextureViewOverlay(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
    ...
    public SmartHelmetTextureViewOverlay(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SmartHelmetTextureViewOverlay(Context context) {
        this(context, null);
    }
