...
public class ContactAvatar {
    ...
    public static void displayAvatar(SmartHelmetContact contact, View v, boolean showBorder) {
    ...
    public static void displayAvatar(SmartHelmetContact contact, View v) {
        displayAvatar(contact, v, false);
    }

    public static void displayAvatar(
            SmartHelmetContact contact, boolean hasLimeX3dhCapability, View v) {
    ...
    public static void displayAvatar(
            SmartHelmetContact contact, ChatRoomSecurityLevel securityLevel, View v) {
        displayAvatar(contact, v);
        setSecurityLevel(securityLevel, v);
    }
