...
import com.datang.smarthelmet.contacts.ContactsUpdatedListener;
import com.datang.smarthelmet.contacts.SmartHelmetContact;
import com.datang.smarthelmet.settings.LinphonePreferences;
import com.datang.smarthelmet.utils.AndroidAudioManager;
...
public class CallActivity extends SmartHelmetGenericActivity
    ...
    private static class HideControlsRunnable implements Runnable {
        ...
        public void run() {
            ...
            Call call = SmartHelmetManager.getCore().getCurrentCall();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        conferencePause.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        SmartHelmetManager.getCallManager().pauseConference();
                        updateCallsList();
                    }
                });
        ...
        hangUp.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        SmartHelmetManager.getCallManager().terminateCurrentCallOrConferenceOrAll();
                    }
                });
        ...
        mSwitchCamera.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        SmartHelmetManager.getCallManager().switchCamera();
                    }
                });
                    ...
                    public void onCallStateChanged(
                        ...
                        if (state == Call.State.End || state == Call.State.Released) {
                            ...
                            boolean showAcceptUpdateDialog =
                                    SmartHelmetManager.getCallManager()
    ...
    protected void onStart() {
        ...
        mCore = SmartHelmetManager.getCore();
        if (mCore != null) {
    ...
    protected void onResume() {
        ...
        mAudioManager = SmartHelmetManager.getAudioManager();
        ...
        SmartHelmetManager.getCallManager().setCallInterface(this);
        ...
        SmartHelmetService.instance().destroyOverlay();
    }

    @Override
    protected void onPause() {
        ContactsManager.getInstance().removeContactsListener(this);
        SmartHelmetManager.getCallManager().setCallInterface(null);
        ...
        if (LinphonePreferences.instance().isOverlayEnabled()
            ...
            if (call.getState() == Call.State.StreamsRunning) {
                ...
                SmartHelmetService.instance().createOverlay();
            }
        }
    ...
    public void resetCallControlsHidingTimer() {
        SmartHelmetUtils.removeFromUIThreadDispatcher(mHideControlsRunnable);
    ...
    private void toggleVideo() {
        ...
        if (call.getCurrentParams().videoEnabled()) {
            SmartHelmetManager.getCallManager().removeVideo();
        } else {
            SmartHelmetManager.getCallManager().addVideo();
        }
    }
    ...
    private void showVideoControls(boolean videoEnabled) {
        ...
        SmartHelmetManager.getInstance().enableProximitySensing(!videoEnabled);
    ...
    private void acceptCallUpdate(boolean accept) {
        ...
        SmartHelmetManager.getCallManager().acceptCallUpdate(accept);
    }
    ...
    private void displayConferenceCall(final Call call) {
        ...
        if (contact != null) {
            ...
            String displayName = SmartHelmetUtils.getAddressDisplayName(call.getRemoteAddress());
            ContactAvatar.displayAvatar(
        ...
        removeFromConference.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        SmartHelmetManager.getCallManager().removeCallFromConference(call);
                    }
                });
    ...
    private void displayPausedConference() {
        ...
        conferenceResume.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        SmartHelmetManager.getCallManager().resumeConference();
                        updateCallsList();
                    }
                });
