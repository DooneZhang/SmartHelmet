...
import com.datang.smarthelmet.compatibility.CompatibilityScaleGestureDetector;
import com.datang.smarthelmet.compatibility.CompatibilityScaleGestureListener;
...
public class VideoZoomHelper extends GestureDetector.SimpleOnGestureListener
    ...
    public boolean onScale(CompatibilityScaleGestureDetector detector) {
        ...
        Call currentCall = SmartHelmetManager.getCore().getCurrentCall();
        if (currentCall != null) {
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
        ...
        if (SmartHelmetUtils.isCallEstablished(core.getCurrentCall())) {
            if (mZoomFactor > 1) {
