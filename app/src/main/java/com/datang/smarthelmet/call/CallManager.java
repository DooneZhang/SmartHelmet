...
import com.datang.smarthelmet.views.AddressType;
...
public class CallManager {
    ...
    public boolean acceptCall(Call call) {
        ...
        boolean isLowBandwidthConnection =
                !SmartHelmetUtils.isHighBandwidthConnection(SmartHelmetService.instance());
    ...
    public void newOutgoingCall(String to, String displayName) {
        ...
        if (!to.startsWith("sip:") || !to.contains("@")) {
            SmartHelmetContact contact =
                    ContactsManager.getInstance().findContactFromPhoneNumber(to);
            if (contact != null) {
    ...
    public void playDtmf(ContentResolver r, char dtmf) {
        ...
        SmartHelmetManager.getCore().playDtmf(dtmf, -1);
    }
    ...
    private void inviteAddress(
        ...
        String recordFile =
                FileUtils.getCallRecordingFilename(SmartHelmetService.instance(), address);
        ...
        if (call != null) {
            ...
            if (mContext.getResources().getBoolean(R.bool.enable_call_notification))
                SmartHelmetService.instance()
                        ...
                        .displayCallNotification(SmartHelmetManager.getCore().getCurrentCall());
        }
    }
}
