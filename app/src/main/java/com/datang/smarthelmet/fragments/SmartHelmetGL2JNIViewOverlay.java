package com.datang.smarthelmet.fragments;
...
public class SmartHelmetGL2JNIViewOverlay extends org.linphone.mediastream.video.display.GL2JNIView
        implements SmartHelmetOverlay {
    ...
    public SmartHelmetGL2JNIViewOverlay(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
                ...
                new AndroidVideoWindowImpl(
                        ...
                        new AndroidVideoWindowImpl.VideoWindowListener() {
                            public void onVideoRenderingSurfaceReady(
                                ...
                                SmartHelmetManager.getCore().setNativeVideoWindowId(vw);
                            }
        ...
        setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Context context = SmartHelmetService.instance();
    ...
    public SmartHelmetGL2JNIViewOverlay(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SmartHelmetGL2JNIViewOverlay(Context context) {
        this(context, null);
    }
