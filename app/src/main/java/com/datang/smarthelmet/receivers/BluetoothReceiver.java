    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(BluetoothHeadset.ACTION_CONNECTION_STATE_CHANGED)) {
            ...
            if (state == BluetoothHeadset.STATE_CONNECTED) {
                ...
                SmartHelmetManager.getAudioManager().bluetoothHeadetConnectionChanged(true);
            } else if (state == BluetoothHeadset.STATE_DISCONNECTED) {
                Log.i("[Bluetooth] Bluetooth headset disconnected");
                SmartHelmetManager.getAudioManager().bluetoothHeadetConnectionChanged(false);
            } else {
            ...
            if (state == BluetoothHeadset.STATE_AUDIO_CONNECTED) {
                ...
                SmartHelmetManager.getAudioManager().bluetoothHeadetAudioConnectionChanged(true);
            } else if (state == BluetoothHeadset.STATE_AUDIO_DISCONNECTED) {
                Log.i("[Bluetooth] Bluetooth headset audio disconnected");
                SmartHelmetManager.getAudioManager().bluetoothHeadetAudioConnectionChanged(false);
            } else {
            ...
            if (state == AudioManager.SCO_AUDIO_STATE_CONNECTED) {
                ...
                SmartHelmetManager.getAudioManager().bluetoothHeadetScoConnectionChanged(true);
            } else if (state == AudioManager.SCO_AUDIO_STATE_DISCONNECTED) {
                Log.i("[Bluetooth] Bluetooth headset SCO disconnected");
                SmartHelmetManager.getAudioManager().bluetoothHeadetScoConnectionChanged(false);
