...
import com.datang.smarthelmet.contacts.SearchContactViewHolder;
import com.datang.smarthelmet.contacts.SearchContactsAdapter;
import com.datang.smarthelmet.contacts.SmartHelmetContact;
import com.datang.smarthelmet.settings.LinphonePreferences;
import com.datang.smarthelmet.views.ContactSelectView;
...
public class ChatRoomCreationFragment extends Fragment
    ...
    public View onCreateView(
        ...
        LinearLayoutManager layoutManager =
                new SmartHelmetLinearLayoutManager(getActivity().getApplicationContext());
        ...
        if (lpc == null || lpc.getConferenceFactoryUri() == null || !mCreateGroupChatRoom) {
            ...
            SmartHelmetContact c =
                    searchResult.getFriend() != null
                            ? (SmartHelmetContact) searchResult.getFriend().getUserData()
                            : null;
            if (c == null) {
