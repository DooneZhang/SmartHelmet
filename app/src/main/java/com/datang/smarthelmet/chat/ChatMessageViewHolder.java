...
public class ChatMessageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void bindMessage(final ChatMessage message, SmartHelmetContact contact) {
        ...
        if (contact != null) {
            if (contact.getFullName() != null) {
                ...
                displayName = SmartHelmetUtils.getAddressDisplayName(remoteSender);
            }
        ...
        if (message.hasTextContent()) {
            ...
            Spanned text = SmartHelmetUtils.getTextWithHttpLinks(msg);
