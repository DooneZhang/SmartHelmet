...
public class ChatMessagesAdapter extends SelectableAdapter<ChatMessageViewHolder>
    ...
    private List<SmartHelmetContact> mParticipants;
    ...
    public ChatMessagesAdapter(
            ...
            int itemResource,
            EventLog[] history,
            ArrayList<SmartHelmetContact> participants,
    ...
    public void onBindViewHolder(@NonNull ChatMessageViewHolder holder, int position) {
        ...
        if (event.getType() == EventLog.Type.ConferenceChatMessage) {
            ...
            SmartHelmetContact contact = null;
            ...
            if (address != null) {
                ...
                if (contact != null) {
                    ...
                    displayName = SmartHelmetUtils.getAddressDisplayName(address);
                }
            }
    ...
    public void setContacts(ArrayList<SmartHelmetContact> participants) {
        mParticipants = participants;
    }
