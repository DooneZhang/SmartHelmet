...
public class ChatRoomViewHolder extends RecyclerView.ViewHolder
    ...
    public void bindChatRoom(ChatRoom room) {
        ...
        if (lastMessage != null) {
            ...
            date.setText(
                    SmartHelmetUtils.timestampToHumanDate(
                            mContext,
    ...
    private String getSender(ChatMessage lastMessage) {
        if (lastMessage != null) {
            ...
            return (SmartHelmetUtils.getAddressDisplayName(lastMessage.getFromAddress())
    ...
    private String getContact(ChatRoom mRoom) {
        ...
        if (mRoom.hasCapability(ChatRoomCapabilities.OneToOne.toInt())) {
            ...
            return SmartHelmetUtils.getAddressDisplayName(contactAddress);
        }
    ...
    private void getAvatar(ChatRoom mRoom) {
        if (mRoom.hasCapability(ChatRoomCapabilities.OneToOne.toInt())) {
            ...
            if (contact != null) {
                ...
                String username = SmartHelmetUtils.getAddressDisplayName(remoteAddr);
                if (mRoom.hasCapability(ChatRoomCapabilities.Encrypted.toInt())) {
