...
public class DevicesFragment extends Fragment {
    ...
    public void onResume() {
        ...
        if (SmartHelmetManager.getInstance().hasLastCallSasBeenRejected()) {
            SmartHelmetManager.getInstance().lastCallSasRejected(false);
            SmartHelmetUtils.showTrustDeniedDialog(getActivity());
        }
    }
    ...
    private void initHeader() {
        if (mRoom.hasCapability(ChatRoomCapabilities.OneToOne.toInt())) {
            ...
            if (c != null) {
                ...
                displayName = SmartHelmetUtils.getAddressDisplayName(remoteParticipantAddr);
            }
