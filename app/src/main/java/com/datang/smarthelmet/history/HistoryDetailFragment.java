        ...
        dialBack.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        SmartHelmetManager.getCallManager().newOutgoingCall(mSipUri, mDisplayName);
                    }
                });
    ...
    private void displayHistory() {
        if (mSipUri != null) {
            ...
            if (address != null && core != null) {
                ...
                mContactAddress.setText(SmartHelmetUtils.getDisplayableAddress(address));
                ...
                if (mContact != null) {
                    ...
                    mContactName.setText(
                            mDisplayName == null
                                    ? SmartHelmetUtils.getAddressDisplayName(mSipUri)
                                    : mDisplayName);
                    ContactAvatar.displayAvatar(
                            SmartHelmetUtils.getAddressDisplayName(address), mAvatarLayout);
